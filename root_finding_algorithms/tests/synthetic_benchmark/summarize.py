...
solvers = ['FPA2', 'Secant', 'Regula Falsi', 'Bissection']
...
\end{table}
'''
TABLELINE = r'&\!\!\! %.1f \!\!\!&\!\!\! %d  \!\!\!&\!\!\! %d  \!\!\!&\!\!\! %.1f  \!\!\!&\!\!\! %.3f  \!\!\!&\!\!\! %.3f & %d'
ENDLINE = r'\\ \hline'
AITKENANDERSON = r'& \multicolumn{7}{c||}{\bf \hspace{-8ex}FPA2} & \multicolumn{7}{c|}{\bf \hspace{-8ex}Secant} \\ \hline'
FPAAFPA = r'& \multicolumn{7}{c||}{\bf Regula Falsi} & \multicolumn{7}{c|}{\bf Bissection} \\ \hline'
...
def latex_report(test, data):
    ...
    for size in sizes:
        print_latex_table(size, ['FPA2', 'Secant'], data)

    print (FPAAFPA)
    for size in sizes:
        print_latex_table(size, ['Regula Falsi', 'Bissection'], data)
